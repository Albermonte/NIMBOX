...
<div class={`flex flex-col p-10 bg-white rounded-24 ${componentClass}`}>
    <div class="flex pb-4">
        <span
            class="w-1/5 font-bold text-center text-18 text-blue-light"
            >Age.</span
        >
        <span
            class="w-4/5 font-bold text-left text-18 text-blue-light"
            >Participant.</span
        >
    </div>
